	...
	public static void initialize() {
		...
		// Ajout du texte des règles du jeu
				...
				try {
					...
					document.insertString(document.getLength(),
							"Le principe du craft est simple. Il vous faudra récolter le plus de plantes possibles dans l'onglet jeu afin de pouvoir les d�penser en fabriquant des potions et am�liorations. Pour cela, il faut selectionner la recette de craft relative au jeu voulu en haut de l'�cran. Lorsqu'un clic est effectu� sur la recette voulue, les informations relatives a celle-ci s'affiche au dessous. Dans ces informations, on peut notamment retrouver le nombre de composants n�cessaires pour r�aliser la potion ou l'am�lioration. Il suffit ensuite de reporter ces nombres dans les cases situ�es en bas de la fen�tre. Une fois cela r�alis�, il suffira de cliquer sur le bouton 'CRAFT', juste au dessous, pour lancer la fabrication. Il aussi possible de consulter son inventaire afin de visualiser l'int�gralit� des plantes, potions et am�liorations disponibles : pour cela il suffit de cliquer sur la caisse en bois. La fen�tre d'inventaire qui s'ouvre, se met a jour toute seule r�gulierement afin de permettre la visualisation des bonnes quantit�s.",
							null);
