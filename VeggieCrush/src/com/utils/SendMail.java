...
public class SendMail {
	 ...
	 */
	public static void sendEmailSSL(String to, String subject, String content)
		...
		Session session = Session.getDefaultInstance(props, new javax.mail.Authenticator() {
			protected PasswordAuthentication getPasswordAuthentication() {
				return new PasswordAuthentication(applicationProperties.getString("mail.session.user"),
						applicationProperties.getString("mail.session.pass"));
			}
		});
